...
if st.session_state['logged_in']:
    ...
    if st.session_state['role'] == 'Enumerator':
        ...
        if case_id in participant['case_id'].values:
            st.error(f'Case ID already entered by {participant[participant["case_id"] == case_id]["enumerator"].values[0]}. Please enter a new case ID')
        else:
